...
import org.mrs.api.impl.ObsServiceImpl;
import org.mrs.obs.ComplexData;
import org.mrs.obs.ComplexObsHandler;
import org.mrs.obs.handler.BinaryDataHandler;
import org.mrs.obs.handler.ImageHandler;
...
public class ObsServiceTest extends BaseContextSensitiveTest {
	...
	public void registerHandler_shouldLoadHandlerAndRegisterKey() {
		...
		os.registerHandler("DummyHandler2", "org.mrs.obs.handler.ImageHandler");
	...
	public void removeHandler_shouldRemoveHandlerWithMatchingKey() {
		...
		os.registerHandler("DummyHandler3", "org.mrs.obs.handler.ImageHandler");
