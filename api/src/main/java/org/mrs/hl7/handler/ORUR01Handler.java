...
import org.mrs.hl7.HL7InQueueProcessor;
...
/**
 * Parses ORUR01 messages into mrs Encounter objects Usage: GenericParser parser = new
...
public class ORUR01Handler implements Application {
	...
	/**
	 * Utility method to retrieve the mrs ConceptName specified in an hl7 message observation
	 * segment. This method assumes that the check for 99NAM has been done already and is being
	 * given an mrs conceptNameId
	 *
	...
	/**
	 * Get an mrs Concept object out of the given hl7 coded element
	 *
	...
	/**
	 * Get an mrs Concept object out of the given hl7 coded with exceptions element
	 *
	 ...
	 * Otherwise, the coding system is looked up in the ConceptMap for an mrs concept mapped to
	 * that code.
	 *
