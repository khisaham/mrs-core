...
import org.mrs.test.StartModule;
...
public class ModuleInteroperabilityTest extends BaseContextSensitiveTest {
	...
	public void shouldAllowModuleAToLoadModuleBIfARequiresB() throws ClassNotFoundException {
		...
		Class<?> module1ServiceClass = loader.loadClass("org.mrs.module.test1.api.Test1Service");
		Class<?> module2ServiceClass = loader.loadClass("org.mrs.module.test2.api.Test2Service");
		...
		Class<?> module1TestClass = module2ClassLoader.loadClass("org.mrs.module.test1.Test1");
		...
		Class<?> module1ServiceClass2 = module2ClassLoader.loadClass("org.mrs.module.test1.api.Test1Service");
