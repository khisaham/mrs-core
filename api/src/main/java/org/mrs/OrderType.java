...
public class OrderType extends BaseChangeableOpenmrsMetadata {
	 ...
	 * Constructor with ID
	 * 
	 * @param orderTypeId the ID of the {@link org.mrs.OrderType}
	 */
	...
	/**
	 * @return Returns the {@link org.mrs.OrderType}
	 */
	...
	/**
	 * @param parent The {@link org.mrs.OrderType} to set
	 */
	...
	/**
	 * @return Get the {@link org.mrs.ConceptClass}es
	 */
	...
	/**
	 * @param conceptClasses the collection containing the {@link org.mrs.ConceptClass}es
	 */
	...
	/**
	 * @see org.mrs.BaseOpenmrsObject#toString()
	 */
	@Override
