...
/**
 * Constants used by the module system in mrs
 */
public class ModuleConstants {
	 ...
	 * mrs. A module with at least the given version is required to start before mrs will
	 * fully start.
	 */
	 ...
	 * @since 1.9.3
	 */
	public static final String MESSAGE_PROPERTY_ALLOW_KEYS_OUTSIDE_OF_MODULE_NAMESPACE = "mrs.property.MESSAGE_PROPERTY_ALLOW_KEYS_OUTSIDE_OF_MODULE_NAMESPACE";
