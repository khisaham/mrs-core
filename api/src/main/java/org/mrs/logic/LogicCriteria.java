...
import org.mrs.logic.op.And;
import org.mrs.logic.op.AsOf;
import org.mrs.logic.op.Average;
import org.mrs.logic.op.Count;
import org.mrs.logic.op.First;
import org.mrs.logic.op.GreaterThan;
import org.mrs.logic.op.GreaterThanEquals;
import org.mrs.logic.op.In;
import org.mrs.logic.op.Last;
import org.mrs.logic.op.LessThan;
import org.mrs.logic.op.LessThanEquals;
import org.mrs.logic.op.Operand;
import org.mrs.logic.op.Operator;
import org.mrs.logic.op.Or;
import org.mrs.logic.op.TransformOperator;
import org.mrs.logic.op.Within;
...
public interface LogicCriteria {
	...
	/**
	 * Add a {@link org.mrs.logic.op.Before} expression to the current LogicCriteria
	 * 
	 * @param value the operand for the Before operator
	 * @return LogicCriteria with Before expression
	 * @see org.mrs.logic.op.Before
	 */
	...
	/**
	 * Add a {@link org.mrs.logic.op.After} expression to the current LogicCriteria
	 * 
	 * @param value the operand for the After operator
	 * @return LogicCriteria with After expression
	 * @see org.mrs.logic.op.After
	 */
	...
	/**
	 * Add a {@link org.mrs.logic.op.Contains} expression to the current LogicCriteria
	 * 
	 * @param value the operand for the Contains operator
	 * @return LogicCriteria with Contains expression
	 * @see org.mrs.logic.op.Contains
	 */
	...
	/**
	 * Add a {@link org.mrs.logic.op.Equals} expression to the current LogicCriteria
	 * 
	 * @param value the operand for the Equals operator
	 * @return LogicCriteria with Equals expression
	 * @see org.mrs.logic.op.Equals
	 */
