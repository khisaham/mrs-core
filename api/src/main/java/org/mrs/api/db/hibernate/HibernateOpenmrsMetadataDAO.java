...
import org.mrs.api.db.OpenmrsMetadataDAO;
...
public class HibernateOpenmrsMetadataDAO<T extends BaseOpenmrsMetadata> extends HibernateOpenmrsObjectDAO<T> implements OpenmrsMetadataDAO<T> {
	...
	/**
	 * @see org.mrs.api.db.OpenmrsMetadataDAO#getAll(boolean)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.db.OpenmrsMetadataDAO#getAll(boolean, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.db.OpenmrsMetadataDAO#getAllCount(boolean)
	 */
	@Override
