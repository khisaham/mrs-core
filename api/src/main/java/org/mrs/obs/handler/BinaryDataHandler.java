...
public class BinaryDataHandler extends AbstractHandler implements ComplexObsHandler {
	...
	/**
	 * Currently supports the following views: org.mrs.obs.ComplexObsHandler#RAW_VIEW
	 * 
	 * @see org.mrs.obs.ComplexObsHandler#getObs(org.mrs.Obs, java.lang.String)
	 */
	@Override
	...
	/**
	 * @see org.mrs.obs.ComplexObsHandler#getSupportedViews()
	 */
	@Override
	 ...
	 * 
	 * @see org.mrs.obs.ComplexObsHandler#saveObs(org.mrs.Obs)
	 */
	@Override
