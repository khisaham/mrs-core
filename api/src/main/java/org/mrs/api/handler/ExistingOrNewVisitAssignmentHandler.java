...
public class ExistingOrNewVisitAssignmentHandler extends ExistingVisitAssignmentHandler implements GlobalPropertyListener {
	...
	/**
	 * @see org.mrs.api.handler.ExistingVisitAssignmentHandler#getDisplayName(java.util.Locale)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.handler.ExistingVisitAssignmentHandler#beforeCreateEncounter(org.mrs.Encounter)
