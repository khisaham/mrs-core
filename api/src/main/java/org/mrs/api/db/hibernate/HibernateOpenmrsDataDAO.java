...
import org.mrs.api.db.OpenmrsDataDAO;
...
public class HibernateOpenmrsDataDAO<T extends BaseOpenmrsData> extends HibernateOpenmrsObjectDAO<T> implements OpenmrsDataDAO<T> {
	...
	/**
	 * @see org.mrs.api.db.OpenmrsDataDAO#getAll(boolean)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.db.OpenmrsDataDAO#getAll(boolean, java.lang.Integer, java.lang.Integer)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.db.OpenmrsDataDAO#getAllCount(boolean)
	 */
	@Override
