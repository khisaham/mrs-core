...
import org.mrs.BaseChangeableOpenmrsMetadata;
...
public abstract class BaseAttributeType<OwningType extends Customizable<?>> extends BaseChangeableOpenmrsMetadata implements AttributeType<OwningType> {
	...
	/**
	 * @see org.mrs.customdatatype.RepeatingCustomValueDescriptor#getMinOccurs()
	 */
	@Override
	...
	/**
	 * @see org.mrs.customdatatype.RepeatingCustomValueDescriptor#getMaxOccurs()
	 */
	@Override
