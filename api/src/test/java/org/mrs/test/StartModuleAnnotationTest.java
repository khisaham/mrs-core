...
public class StartModuleAnnotationTest extends BaseModuleContextSensitiveTest {
	...
	public void shouldStartModules() throws ClassNotFoundException {
		...
		Class<?> atdServiceClass = Context.loadClass("org.mrs.module.atdproducer.service.ATDService");
		Class<?> dssServiceClass = Context.loadClass("org.mrs.module.dssmodule.DssService");
