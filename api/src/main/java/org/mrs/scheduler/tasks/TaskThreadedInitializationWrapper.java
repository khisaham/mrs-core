...
public class TaskThreadedInitializationWrapper implements Task {
	...
	/**
	 * @see org.mrs.scheduler.Task#execute() Executes the task defined in the task definition
	...
	/**
	 * @see org.mrs.scheduler.Task#initialize(org.mrs.scheduler.TaskDefinition) Initializes
	...
	/**
	 * @see org.mrs.scheduler.Task#getTaskDefinition()
	 */
	@Override
	...
	/**
	 * @see org.mrs.scheduler.Task#isExecuting()
	 */
	@Override
	...
	/**
	 * @see org.mrs.scheduler.Task#shutdown()
	 */
	@Override
