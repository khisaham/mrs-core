...
public class EmptyResult extends Result {
	...
	/**
	 * @see org.mrs.logic.result.Result#addAll(java.util.Collection)
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#addAll(int, java.util.Collection)
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#clear()
	 */
	@Override
	public void clear() {
	...
	/**
	 * @see org.mrs.logic.result.Result#isEmpty()
	 * @should return true
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#toBoolean()
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#isNull()
	 * @should return true
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#remove(int)
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#remove(java.lang.Object)
	 */
	@Override
	...
	/**
	 * @see org.mrs.logic.result.Result#removeAll(java.util.Collection)
	 */
	@Override
