...
public class InitializationWizardModel {
	...
	/**
	 * DB user that can create an mrs db user Filled in on databasetablesanduser.vm
	 */
	...
	/**
	 * The username of a user that exists that can read/write to mrs. Entered on
	 * databasetablesanduser page
	 */
	public String currentDatabaseUsername = "";
	
	/**
	 * The password of a user that exists that can read/write to mrs. Entered on
	 * databasetablesanduser page
	 */
	...
	/**
	 * if the user asked us to create the user for mrs
	 */
