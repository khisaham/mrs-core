...
public class LocationServiceTest extends BaseContextSensitiveTest {
	...
	/**
	 * @see LocationService#getLocations(String, org.mrs.Location, java.util.Map, boolean, Integer, Integer)
	 */
	@Test
	public void getLocations_shouldNotFindAnyLocationsIfNoneHaveGivenAttributeValues() {
		...
		phoneAttrType.setDatatypeClassname("org.mrs.customdatatype.datatype.FreeTextDatatype");
	...
	public void getLocations_shouldGetLocationsHavingAllMatchingAttributeValues() {
		...
		emailAttrType.setDatatypeClassname("org.mrs.customdatatype.datatype.FreeTextDatatype");
