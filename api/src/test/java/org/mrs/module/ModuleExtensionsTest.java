...
public class ModuleExtensionsTest extends BaseContextMockTest {
	...
	private static final String EXTENSION_POINT_ID_PATIENT_DASHBOARD = "org.mrs.patientDashboard";
	...
	@Before
	public void before() {
		module = new Module("Extension Test", "extensiontest", "org.mrs.module.extensiontest", "", "", "0.0.1");
	}
	...
	public void getExtensions_shouldNotFailExpandingAnExtensionNameCausingANoClassDefinitionFoundError() {
		...
		// java.lang.NoClassDefFoundError: org/mrs/module/web/extension/AdministrationSectionExt
	...
	public void getExtensions_shouldNotFailExpandingAClassWhichCannotBeFound() {
		...
		HashMap<String, String> extensionNames = new HashMap<>();
		extensionNames.put(EXTENSION_POINT_ID_PATIENT_DASHBOARD, "org.mrs.unknown.Nonexisting.class");
		module.setExtensionNames(extensionNames);
