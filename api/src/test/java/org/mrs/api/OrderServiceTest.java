...
import static org.mrs.test.OpenmrsMatchers.hasId;
import static org.mrs.test.TestUtil.containsId;
...
import org.mrs.FreeTextDosingInstructions;
import org.mrs.GlobalProperty;
import org.mrs.Obs;
import org.mrs.Order;
import org.mrs.Order.Action;
...
import org.mrs.SimpleDosingInstructions;
import org.mrs.TestOrder;
import org.mrs.api.builder.OrderBuilder;
import org.mrs.api.context.Context;
import org.mrs.api.impl.OrderServiceImpl;
import org.mrs.messagesource.MessageSourceService;
import org.mrs.order.OrderUtil;
import org.mrs.order.OrderUtilTest;
import org.mrs.orders.TimestampOrderNumberGenerator;
import org.mrs.parameter.OrderSearchCriteria;
import org.mrs.parameter.OrderSearchCriteriaBuilder;
import org.mrs.test.BaseContextSensitiveTest;
import org.mrs.test.TestUtil;
import org.mrs.util.DateUtil;
...
public class OrderServiceTest extends BaseContextSensitiveTest {
	...
	/**
	 * @see OrderService#saveOrder(org.mrs.Order, OrderContext)
	 */
	@Test
	...
	/**
	 * @see OrderService#purgeOrder(org.mrs.Order, boolean)
	 */
	@Test
	...
	/**
	 * @see OrderService#getOrderHistoryByConcept(org.mrs.Patient, org.mrs.Concept)
	 */
	@Test
	...
	/**
	 * @see OrderService#getOrderFrequencyByConcept(org.mrs.Concept)
	 */
	@Test
	...
	/**
	 * @see OrderService#getActiveOrders(org.mrs.Patient, org.mrs.OrderType,
	...
	/**
	 * @see OrderService#discontinueOrder(org.mrs.Order, String, java.util.Date,
	...
	/**
	 * @see OrderService#discontinueOrder(org.mrs.Order, org.mrs.Concept, java.util.Date,
	 *      org.mrs.Provider, org.mrs.Encounter)
	 */
	@Test
	...
	/**
	 * @see OrderService#updateOrderFulfillerStatus(org.mrs.Order, Order.FulfillerStatus, String)
	 */
	@Test
	...
	/**
	 * @see OrderService#saveOrderType(org.mrs.OrderType)
	 */
	@Test
	...
	/**
	 * @see OrderService#purgeOrderType(org.mrs.OrderType)
	 */
	@Test
	...
	/**
	 * @see OrderService#retireOrderType(org.mrs.OrderType, String)
	 */
	@Test
	...
	/**
	 * @see OrderService#unretireOrderType(org.mrs.OrderType)
	 */
	@Test
	...
	/**
	 * @see OrderService#getSubtypes(org.mrs.OrderType, boolean)
	 */
	@Test
	...
	/**
	 * @see OrderService#voidOrder(org.mrs.Order, String)
	 */
	@Test
	...
	/**
	 * @see OrderService#unvoidOrder(org.mrs.Order)
	 */
	@Test
	...
	/**
	 * @see OrderService#getRevisionOrder(org.mrs.Order)
	 */
	@Test
	...
	/**
	 * @see OrderService#saveOrder(org.mrs.Order, OrderContext, org.mrs.Order[])
	 */
	@Test
