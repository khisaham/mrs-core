...
public class OpenmrsProfileExcludeFilter implements TypeFilter {
	 ...
	 * @throws IOException
	 *
	 * @should not include bean for mrs from 1_6 to 1_7
	 * @should include bean for mrs 1_10 and later
	 * @should not include bean for mrs 1_8 and later if module missing
	 * @should include bean for mrs 1_8 and later
	 */
	@Override
	public boolean match(MetadataReader metadataReader, MetadataReaderFactory metadataReaderFactory) throws IOException {
		Map<String, Object> openmrsProfileAttributes = metadataReader.getAnnotationMetadata().getAnnotationAttributes(
				"org.mrs.annotation.OpenmrsProfile");
