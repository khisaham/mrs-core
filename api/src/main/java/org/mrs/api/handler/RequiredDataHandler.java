 ...
 * services. The {@link org.mrs.aop.RequiredDataAdvice} uses AOP around each method to call all
 * handlers that a certain interface. Having this super interface makes it easier to have one method
 * for this.
 * 
 * @see org.mrs.aop.RequiredDataAdvice#recursivelyHandle(Class, OpenmrsObject, User, Date,
 *      String, java.util.List)
 * @see org.mrs.aop.RequiredDataAdvice
 * @see SaveHandler
 * @see VoidHandler
 * @see RetireHandler
 * @since 1.5
