...
import org.mrs.customdatatype.datatype.RegexValidatedTextDatatype;
...
public class BaseAttributeTypeValidatorTest extends BaseContextSensitiveTest {
	...
	public void shouldFailIfPreferredHandlerClassIsOfWrongDatatype() {
		...
		attributeType.setPreferredHandlerClassname("org.mrs.attribute.handler.DateDatatypeHandler");
