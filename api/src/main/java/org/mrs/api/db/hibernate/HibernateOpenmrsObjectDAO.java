...
import org.mrs.api.db.OpenmrsObjectDAO;
...
public class HibernateOpenmrsObjectDAO<T extends BaseOpenmrsObject> implements OpenmrsObjectDAO<T> {
	...
	/**
	 * @see org.mrs.api.db.OpenmrsObjectDAO#getByUuid(java.lang.String)
	 */
	@Override
	...
	/** 
	 * @see org.mrs.api.db.OpenmrsObjectDAO#delete(org.mrs.BaseOpenmrsObject)
	 */
	@Override
	...
	/**
	 * @see org.mrs.api.db.OpenmrsObjectDAO#saveOrUpdate(org.mrs.BaseOpenmrsObject)
	 */
	@Override
