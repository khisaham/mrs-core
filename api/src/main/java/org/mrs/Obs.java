...
import org.mrs.util.Format;
import org.mrs.util.Format.FORMAT_TYPE;
...
public class Obs extends BaseChangeableOpenmrsData {
	 ...
	 * org.mrs.Concept#isSet()) If this is non-null, it means the current Obs is in the list
	 ...
	 * <p>
	 * If it's not a group (i.e. {@link #getConcept()}.{@link org.mrs.Concept#getSet()} is not
