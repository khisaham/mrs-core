...
public interface PersonService extends OpenmrsService {
	...
	/**
	 * Voids the given Relationship, effectively removing it from mrs.
	 * 
	 ...
	 * {@link org.mrs.person.PersonMergeLog#getPersonMergeLogData}, sets the mergedData String,
	 ...
	 * @see org.mrs.person.PersonMergeLog
	 * @see org.mrs.api.handler.OpenmrsObjectSaveHandler
