...
public class MigrateDataSet {
	...
	private static String OLD_SCHEMA_FILE = "/home/ben/workspace/mrs-trunk/metadata/model/1.3.0-schema-only.sql";
	
	private static String OLD_UPDATE_FILE = "/home/ben/workspace/mrs-trunk/metadata/model/update-to-latest-db.mysqldiff.sql";
	
	private static String NEW_UPDATE_FILE = "/home/ben/workspace/mrs-concept-name-tag/metadata/model/update-to-latest-db.mysqldiff.sql";
