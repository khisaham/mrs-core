...
public interface LogicContext {
	 ...
	 * @see org.mrs.logic.LogicService#eval(Patient, String)
	 */
	 ...
	 * @return <code>Result</code> of the evaluation
	 * @throws LogicException
	 * @see org.mrs.logic.LogicService#eval(Patient, String, Map)
	 */
	 ...
	 * @throws LogicException
	 * @see org.mrs.logic.LogicService#eval(Patient, LogicCriteria, Map)
	 */
