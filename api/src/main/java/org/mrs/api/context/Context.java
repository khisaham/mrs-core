...
import org.mrs.api.ConditionService;
import org.mrs.api.DatatypeService;
import org.mrs.api.DiagnosisService;
...
import org.mrs.api.OpenmrsService;
...
import org.mrs.api.SerializationService;
...
import org.mrs.logic.LogicService;
...
import org.mrs.notification.MessagePreparator;
import org.mrs.notification.MessageSender;
import org.mrs.notification.MessageService;
import org.mrs.notification.mail.MailMessageSender;
import org.mrs.notification.mail.velocity.VelocityMessagePreparator;
import org.mrs.scheduler.SchedulerService;
 ...
 * </pre>
 *
 * @see org.mrs.api.context.UserContext
 * @see org.mrs.api.context.ServiceContext
 */
public class Context {
	 ...
	 * @see org.mrs.util.OpenmrsUtil#getDateFormat(Locale)
	 ...
	 *
	 * @return SimpleDateFormat for the user's current locale
	 * @see org.mrs.util.OpenmrsUtil#getTimeFormat(Locale)
	 ...
	 *
	 * @return SimpleDateFormat for the user's current locale
	 * @see org.mrs.util.OpenmrsUtil#getDateTimeFormat(Locale)
	 ...
	 * @see org.mrs.api.context.ServiceContext#isRefreshingContext()
	 */
	...
	/**
	 * @see org.mrs.api.context.ServiceContext#setUseSystemClassLoader(boolean)
	 * @since 1.10
	 */
	...
	/**
	 * @see org.mrs.api.context.ServiceContext#isUseSystemClassLoader()
	 * @since 1.10
	 */
