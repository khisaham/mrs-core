...
import static org.mrs.test.TestUtil.assertCollectionContentsEquals;
import static org.mrs.util.AddressMatcher.containsAddress;
import static org.mrs.util.NameMatcher.containsFullName;
...
import org.mrs.api.impl.PatientServiceImpl;
import org.mrs.api.impl.PatientServiceImplTest;
import org.mrs.comparator.PatientIdentifierTypeDefaultComparator;
...
import org.mrs.test.SkipBaseSetup;
 ...
 * Before adding a test, check if you can better test it with @see org.mrs.api.{@link PatientServiceImplTest}, which
...
public class PatientServiceTest extends BaseContextSensitiveTest {
	...
	public void getAllIdentifierValidators_shouldReturnAllRegisteredIdentifierValidators() throws Exception {
		...
		expectedValidators.add(patientService.getIdentifierValidator("org.mrs.patient.impl.LuhnIdentifierValidator"));
		expectedValidators
		        .add(patientService.getIdentifierValidator("org.mrs.patient.impl.VerhoeffIdentifierValidator"));
	...
	// *
	// * @see org.mrs.test.BaseContextSensitiveTest#getRuntimeProperties()
	// */
	//* @Override
	...
	public void getIdentifierValidator_shouldReturnPatientIdentifierValidatorGivenClassName() throws Exception {
		IdentifierValidator identifierValidator = Context.getPatientService().getIdentifierValidator(
		    "org.mrs.patient.impl.LuhnIdentifierValidator");
		...
		identifierValidator = Context.getPatientService().getIdentifierValidator(
		    "org.mrs.patient.impl.VerhoeffIdentifierValidator");
		Assert.assertNotNull(identifierValidator);
	...
	/**
	 * @see PatientService#mergePatients(org.mrs.Patient, org.mrs.Patient)
	 */
	@Test
